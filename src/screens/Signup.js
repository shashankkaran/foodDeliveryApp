...
export default function Signup() {
  ...
  const handleClick = async (e) => {
    ...
    const response = await fetch("https://taniproject.onrender.com/api/auth/getlocation", {
      method: 'POST',
      headers: {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    const response = await fetch("https://taniproject.onrender.com/api/auth/createuser", {
      // credentials: 'include',
